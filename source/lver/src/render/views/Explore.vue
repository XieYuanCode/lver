<template>
  <div vertical justify="space-between" class="explore-main">
    <n-space justify="end">
      <n-popover trigger="hover" :delay="500">
        <template #trigger>
          <n-button
            size="small"
            @click="switchLogExploreView"
            :type="exploreLogSwitchButtonType"
          >
            <template #icon> <log-icon /></template>
          </n-button>
        </template>
      ...
      <n-popover trigger="hover" :delay="500">
        <template #trigger>
          ...
          >
            <template #icon> <log-rule-icon /></template>
          </n-button>
        </template>
    ...
    <n-modal
      v-model:show="showCreateLogRuleDialog"
      preset="card"
      :style="{ width: '70%' }"
    >
    ...
    <n-modal
      v-model:show="showImportLogFileDialog"
      preset="card"
      :style="{ width: '70%' }"
    >
